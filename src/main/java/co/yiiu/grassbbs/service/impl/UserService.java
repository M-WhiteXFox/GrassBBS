...
import co.yiiu.grassbbs.mapper.UserMapper;
import co.yiiu.grassbbs.model.User;
import co.yiiu.grassbbs.service.*;
import co.yiiu.grassbbs.util.MyPage;
import co.yiiu.grassbbs.util.SpringContextUtil;
import co.yiiu.grassbbs.util.StringUtil;
import co.yiiu.grassbbs.util.bcrypt.BCryptPasswordEncoder;
import co.yiiu.grassbbs.util.identicon.Identicon;
