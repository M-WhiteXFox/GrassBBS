...
import co.yiiu.grassbbs.mapper.TopicMapper;
...
public class ElasticSearchPlugin {
    ...
    @Around("co.yiiu.grassbbs.hook.TopicServiceHook.search()")
    ...
    @After("co.yiiu.grassbbs.hook.IndexedServiceHook.indexAllTopic()")
    ...
    @After("co.yiiu.grassbbs.hook.IndexedServiceHook.indexTopic()")
    ...
    @After("co.yiiu.grassbbs.hook.IndexedServiceHook.deleteTopicIndex()")
    ...
    @After("co.yiiu.grassbbs.hook.IndexedServiceHook.batchDeleteIndex()")
