package co.yiiu.grassbbs.plugin;
...
public class RedisCachePlugin {
    ...
    @Around("co.yiiu.grassbbs.hook.TopicServiceHook.selectById()")
    ...
    @Around("co.yiiu.grassbbs.hook.TopicServiceHook.updateViewCount()")
    ...
    @Around("co.yiiu.grassbbs.hook.TopicServiceHook.vote()")
    ...
    @After("co.yiiu.grassbbs.hook.TopicServiceHook.update()")
    ...
    @Around("co.yiiu.grassbbs.hook.CommentServiceHook.selectByTopicId()")
    ...
    @After("co.yiiu.grassbbs.hook.CommentServiceHook.insert()")
    ...
    @After("co.yiiu.grassbbs.hook.CommentServiceHook.update()")
    public void commentUpdate(JoinPoint joinPoint) {
        Comment comment = (Comment) joinPoint.getArgs()[0];
        redisService.delString(String.format(RedisKeys.REDIS_COMMENTS_KEY, comment.getTopicId()));
    }

    @After("co.yiiu.grassbbs.hook.CommentServiceHook.delete()")
    public void commentDelete(JoinPoint joinPoint) {
        Comment comment = (Comment) joinPoint.getArgs()[0];
        redisService.delString(String.format(RedisKeys.REDIS_COMMENTS_KEY, comment.getTopicId()));
    }

    @Around("co.yiiu.grassbbs.hook.CommentServiceHook.vote()")
    ...
    @Around("co.yiiu.grassbbs.hook.UserServiceHook.selectByUsername()")
    ...
    @Around("co.yiiu.grassbbs.hook.UserServiceHook.selectByToken()")
    ...
    @Around("co.yiiu.grassbbs.hook.UserServiceHook.selectById()")
    ...
    @After("co.yiiu.grassbbs.hook.UserServiceHook.delRedisUser()")
