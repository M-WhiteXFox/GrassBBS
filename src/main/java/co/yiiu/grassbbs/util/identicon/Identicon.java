package co.yiiu.grassbbs.util.identicon;

import co.yiiu.grassbbs.service.ISystemConfigService;
import co.yiiu.grassbbs.util.HashUtil;
import co.yiiu.grassbbs.util.MD5Util;
import co.yiiu.grassbbs.util.StringUtil;
import co.yiiu.grassbbs.util.identicon.generator.IBaseGenerator;
import co.yiiu.grassbbs.util.identicon.generator.impl.MyGenerator;
