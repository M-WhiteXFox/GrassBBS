...
import co.yiiu.grassbbs.config.realm.MyCredentialsMatcher;
import co.yiiu.grassbbs.config.realm.MyShiroRealm;
...
//        map.put("/admin/user/**", "user");
    ...
    public CookieRememberMeManager rememberMeManager() {
        ...
        cookieRememberMeManager.setCipherKey(Base64.encode("grassbbs is the best!".getBytes()));
