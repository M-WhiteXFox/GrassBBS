    ...
    <div class="row">
        <div class="col-md-9">
            <div class="carousel-main">
                <#include "components/carousel.ftl"/>
                <@carousel images=carousels showIndicators=true showControls=true/>
            </div>
            <div class="card">
        ...
        <div class="col-md-3 d-none d-md-block">
            ...
            <@score limit=10/>
            <#include "components/server_info.ftl"/>
        </div>
        <div>
            <#include "comment/ai.ftl">
            <@aiAssistant topicContent=""/>
        </div>
    </div>
</@html>
